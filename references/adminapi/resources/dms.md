...
| GET | `/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/collections/{col}` | get MongoDB collection stats | [View](../operations/getMongoCollection.md) |
| POST | `/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/collections/{col}` | create MongoDB collection | [View](../operations/mongoCreateCollection.md) |
| DELETE | `/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/collections/{col}` | drop a MongoDB collection or view | [View](../operations/dropMongoCollection.md) |
| POST | `/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/collections/{col}/find` | find documents in a MongoDB collection | [View](../operations/mongoFind.md) |
| POST | `/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/collections/{col}/aggregate` | run MongoDB aggregation pipeline preview | [View](../operations/mongoAggregate.md) |
| POST | `/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/collections/{col}/insert` | insert MongoDB document(s) | [View](../operations/mongoInsert.md) |
| POST | `/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/collections/{col}/update` | update a single MongoDB document | [View](../operations/mongoUpdate.md) |
| POST | `/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/collections/{col}/delete` | delete a single MongoDB document | [View](../operations/mongoDelete.md) |
| POST | `/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/collections/{col}/replace` | replace a single MongoDB document | [View](../operations/mongoReplace.md) |
| GET | `/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/collections/{col}/indexes` | list MongoDB collection indexes | [View](../operations/mongoListIndexes.md) |
| POST | `/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/collections/{col}/indexes` | create MongoDB collection index | [View](../operations/mongoCreateIndex.md) |
| DELETE | `/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/collections/{col}/indexes/{indexName}` | drop MongoDB collection index | [View](../operations/mongoDropIndex.md) |
| GET | `/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/collections/{col}/schema` | analyze MongoDB collection schema from sample documents | [View](../operations/mongoAnalyzeSchema.md) |
| GET | `/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/collections/{col}/validation` | get MongoDB collection validation options | [View](../operations/mongoGetValidation.md) |
| PUT | `/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/collections/{col}/validation` | set MongoDB collection validation options | [View](../operations/mongoSetValidation.md) |
| POST | `/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/views` | create MongoDB view from a read-only aggregation pipeline | [View](../operations/mongoCreateView.md) |
| POST | `/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/explain` | explain a MongoDB query | [View](../operations/mongoExplain.md) |
| POST | `/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/shell/sessions` | create MongoDB mongosh runtime session | [View](../operations/mongoCreateShellSession.md) |
| DELETE | `/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/shell/sessions/{sessionID}` | close MongoDB mongosh runtime session | [View](../operations/mongoCloseShellSession.md) |
| GET | `/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/shell/sessions/{sessionID}/prompt` | get MongoDB mongosh session prompt | [View](../operations/mongoGetShellPrompt.md) |
| POST | `/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/shell/sessions/{sessionID}/evaluate` | evaluate input in a MongoDB mongosh session | [View](../operations/mongoEvaluateShell.md) |
| POST | `/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/shell/sessions/{sessionID}/completions` | get completions for a MongoDB mongosh session | [View](../operations/mongoCompleteShell.md) |
| POST | `/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/shell/sessions/{sessionID}/interrupt` | interrupt current MongoDB mongosh session operation | [View](../operations/mongoInterruptShell.md) |
